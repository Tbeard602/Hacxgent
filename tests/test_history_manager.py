...
from hacxgent.core.paths.config_paths import DEFAULT_HISTORY_SEED, ensure_history_file
...
def test_ensure_history_file_creates_empty_file(tmp_path: Path) -> None:
...
def test_ensure_history_file_clears_default_seed(tmp_path: Path) -> None:
    history_file = tmp_path / "history.jsonl"
    history_file.write_text(DEFAULT_HISTORY_SEED, encoding="utf-8")
