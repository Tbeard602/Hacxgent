...
from tests.conftest import (
    ...
    build_test_hacxgent_app,
    build_test_hacxgent_config,
)
...
async def test_ui_displays_messages_when_resuming_session(
    ...
    agent_loop = build_test_agent_loop(config=hacxgent_config)
...
async def test_ui_rebuilds_history_when_whats_new_is_shown(
    ...
    config = build_test_hacxgent_config(enable_update_checks=True)
    ...
    with patch("hacxgent.cli.update_notifier.whats_new.HACXGENT_ROOT", tmp_path):
