...
@pytest.mark.asyncio
async def test_ctrl_c_triggers_copy_selection() -> None:
    """Test that ctrl+c keybinding triggers copy_selection_to_clipboard."""
    app = BaseSnapshotTestApp()

    with patch("hacxgent.cli.textual_ui.app.copy_selection_to_clipboard") as mock_copy:
