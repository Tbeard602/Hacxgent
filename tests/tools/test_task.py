...
from hacxgent.core.agents.models import BUILTIN_AGENTS, AgentType
from hacxgent.core.tools.base import BaseToolState, InvokeContext, ToolError
from hacxgent.core.tools.builtins.task import Task, TaskArgs, TaskResult, TaskToolConfig
from hacxgent.core.types import AssistantEvent, LLMMessage, Role
...
class TestTaskToolExecution:
    ...
    async def test_happy_path_returns_subagent_response(
        ...
        with patch("hacxgent.core.tools.builtins.task.AgentLoop") as mock_agent_loop_class:
