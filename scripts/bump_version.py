...
Also, remember to fill in hacxgent/whats_new.md if needed (you can leave it blank). 📝
...
def clean_up_whats_new_message() -> None:
    whats_new_path = Path("hacxgent/whats_new.md")
...
Examples:
  ...
  uv run scripts/bump_version.py patch    # 1.0.0 -> 1.0.1
    ...
    try:
        ...
        # Update hacxgent/core/__init__.py
        update_hard_values_files(
            "hacxgent/__init__.py",
