...
from hacxgent.acp.tools.base import AcpToolState, BaseAcpTool
from hacxgent.core.tools.base import ToolError
...
from hacxgent.core.types import ToolCallEvent, ToolResultEvent
...
class SearchReplace(CoreSearchReplaceTool, BaseAcpTool[AcpSearchReplaceState]):
    ...
    prompt_path = (
        HACXGENT_ROOT / "core" / "tools" / "builtins" / "prompts" / "search_replace.md"
    )
