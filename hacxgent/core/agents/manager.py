...
from hacxgent.core.paths.config_paths import resolve_local_agents_dir
from hacxgent.core.paths.global_paths import GLOBAL_AGENTS_DIR
...
class AgentManager:
    def __init__(
        self,
        config_getter: Callable[[], HacxgentConfig],
        ...
        self._cached_config: HacxgentConfig | None = None
