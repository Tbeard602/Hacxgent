...
from hacxgent.core.utils import is_windows, utc_now

if TYPE_CHECKING:
    from hacxgent.core.agents.models import AgentProfile
...
class SessionLogger:
    ...
    def _get_title(self, messages: list[LLMMessage]) -> str:
        ...
        if first_user_message is None:
            ...
            MAX_TITLE_LENGTH = 50
            text = str(first_user_message.content or "")
