...
from hacxgent.cli.textual_ui.widgets.messages import WhatsNewMessage
from hacxgent.cli.textual_ui.windowing.history import (
    build_tool_call_map,
    split_history_tail,
    visible_history_indices,
    visible_history_widgets_count,
)
from hacxgent.cli.textual_ui.windowing.state import SessionWindowing
from hacxgent.core.types import LLMMessage
